...
export default function Hero() {
  return (
    <div className="flex flex-col items-center justify-start mt-5 lg:mt-10">
      ...
      <div className="absolute bottom-0 w-[120px] h-[40%] md:w[150] md:h-[300px] lg:w-[140px] lg:h-[400px] transform rotate-180">
